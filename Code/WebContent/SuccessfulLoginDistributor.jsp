...
<body>
	...
	<div id="socialMediaBox"
		style="float: left; height: 280px; width: 320px; background-color: silver; margin-top: 15px; border-radius: 10px;">

		<p style="font-size: 20px; margin-left: 30px; margin-top: 15px;">
			<b>Tweets</b>
		</p>
		<form
			style="margin-left: 30px; background-color: white; margin-right: 30px; border-radius: 10px">
		</form>
	</div>
