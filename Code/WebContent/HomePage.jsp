...
<body>
	...
	<div id="mainBanner">
		...
		<form>
			<div style="float: right; margin-top: 80px; margin-right: 75px">
				<ul id="menu">
					<li><a href="/com.AsePhase1/HomePage.jsp">Home</a></li>
	...
	<div id="signInBox"
		style="float: right; height: 280px; width: 320px; background-color: silver; margin-top: 15px; border-radius: 10px;">

		<p style="font-size: 25px; margin-left: 30px; margin-top: 30px;">
			<b>Login Form</b>
		</p>
		<div id="signInForm"
			style="margin-top: 0px; margin-left: 30px; background-color: white; margin-right: 30px; border-radius: 10px">
			<form action="loginValidatePath" method="post"
				onsubmit="return evaluateUserInput()">
				<input type="text" id="userName" name="userEmail"
					style="padding: 3px; border-radius: 6px; margin: 5px; margin-top: 10px; min-width: 215px; min-height: 22px; background-color: #EDFAED;"
					placeholder="Enter Email" autofocus>
				<!--  -->
				<input type="password" id="passWord" name="passWord"
					style="padding: 3px; border-radius: 6px; margin: 5px; margin-top: 5px; min-width: 215px; min-height: 22px; background-color: #EDFAED;"
					placeholder="Enter Password">
				<!--  -->

				<input type="submit"
					style="padding: 5px; border-radius: 6px; background-color: #40BC40; width: 80px; margin-left: 85px; font-size: 15px; margin-top: 5px; font-weight: bold;"
					value="Login">
			</form>
			...
			<form target="popup"
				onsubmit="window.open('SignUp.html'); return true;">
				<input
					style="padding: 5px; border-radius: 6px; background-color: #40BC40; width: 100px; font-size: 15px; margin-left: 75px; margin-top: 10px; margin-bottom: 10px; font-weight: bold;"
	...
	<div id="videoBox"
		...
		<video width="500px" height="280px" controls autoplay="autoplay">
		<source src="img\video2.mp4" type="video/mp4"> <source
